...
Для работы виджетов у вас должна быть установлена и настроена интеграции [Space Weather](https://github.com/Eugen417/HA_xras_space_weather) отдающие базовые сенсоры (xras.ru, aurora и т.д.). Ниже приведена процедура создания единого вспомогательного сенсора, который объединит все данные для отправки на экран.

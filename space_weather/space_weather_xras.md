...
Для работы виджетов у вас должна быть установлена и настроена интеграции [Space Weather](https://github.com/Eugen417/HA_xras_space_weather) (v3.0.3 и выше) отдающие базовые сенсоры (xras.ru, aurora и т.д.) и вспомогательный датчик. Ниже приведена процедура создания единого вспомогательного сенсора, который объединит все данные для отправки на экран.
...
### 1. Добавление источник данных (Data Source)

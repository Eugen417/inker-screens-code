...
2) 6 виджетов, информер [Космическая погода](/space_weather/space_weather_xras.md) по данным [xras.ru](xras.ru)
...
3) 15 виджетов, Погодный информер: [Open Meteo](https://github.com/Eugen417/inker-screens-code/blob/main/open_meteo.md)
